...
pub struct Emit<'r> {
    ...
    /// The enum tyle for enums and their constants
    pub enum_style: super::EnumStyle,
    ...
    /// If true, a version header is added the emitted bindings file
